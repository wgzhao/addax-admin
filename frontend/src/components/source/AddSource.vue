              ...
              <v-row dense class="section-body">
                <v-col cols="12">
                  <div class="field-stack">
                    ...
                    <v-text-field
                      v-model="sourceItem.code"
                      placeholder="两位大写字母"
                      autocomplete="off"
                      :rules="[rules.required, rules.codeExistsRule]"
                      :disabled="mode === 'edit'"
                      variant="outlined"
                      density="compact"
                      hide-details="auto"
                ...
                <v-col cols="12">
                  <div class="field-stack">
                    ...
                    <v-text-field
                      v-model.number="sourceItem.maxConcurrency"
                      type="number"
                      variant="outlined"
                      density="compact"
                      placeholder="默认10"
                ...
                <v-col cols="12">
                  <div class="field-stack">
                    ...
                    <div class="field-control status-switch-wrap">
                      ...
                      <v-chip
                        size="x-small"
                        :color="sourceItem.enabled ? 'success' : 'error'"
                        :text="sourceItem.enabled ? '已启用' : '已禁用'"
                        class="ml-1"
                      ></v-chip>
                    </div>
                  </div>
              ...
              <v-row dense class="section-body">
                <v-col cols="12">
                  <div class="field-stack">
                    ...
                    <v-text-field
                      v-model="sourceItem.url"
                      placeholder="jdbc:hive2://host:port"
                      :rules="[rules.required]"
                      variant="outlined"
                      density="compact"
                      hide-details="auto"
...
<script setup lang="ts">
  ...
  watch(
    () => [props.sid, props.mode, props.cloneData],
    () => {
      initializeForm();
    },
    { immediate: true }
