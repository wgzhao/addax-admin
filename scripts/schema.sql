...
ALTER TABLE ONLY public.sys_item DROP CONSTRAINT tb_item_dict_fk;
ALTER TABLE ONLY public.group_members DROP CONSTRAINT fk_group_members_group;
ALTER TABLE ONLY public.group_authorities DROP CONSTRAINT fk_group_authorities_group;
ALTER TABLE ONLY public.authorities DROP CONSTRAINT fk_authorities_users;
ALTER TABLE ONLY public.etl_table DROP CONSTRAINT etl_table_sid_fk;
ALTER TABLE ONLY public.etl_jour DROP CONSTRAINT etl_jour_tid_fk;
ALTER TABLE ONLY public.etl_job DROP CONSTRAINT etl_job_tid_fk;
ALTER TABLE ONLY public.etl_column DROP CONSTRAINT etl_column_tid_fk;
DROP TRIGGER trg_etl_job_queue_set_updated_at ON public.etl_job_queue;
DROP TRIGGER trg_etl_job_queue_notify_upd ON public.etl_job_queue;
DROP TRIGGER trg_etl_job_queue_notify_ins ON public.etl_job_queue;
DROP INDEX public.uniq_active_etl_job;
DROP INDEX public.uk_tid_column_name;
DROP INDEX public.ix_auth_username;
DROP INDEX public.idx_tid_run_date;
DROP INDEX public.idx_sta_tid;
DROP INDEX public.idx_etl_jour_tid;
DROP INDEX public.idx_etl_job_queue_status_available;
DROP INDEX public.idx_etl_job_queue_lease;
ALTER TABLE ONLY public.users DROP CONSTRAINT users_pkey;
ALTER TABLE ONLY public.etl_table DROP CONSTRAINT tb_imp_etl_pkey1;
ALTER TABLE ONLY public.etl_statistic DROP CONSTRAINT tb_addax_statistic_pkey;
ALTER TABLE ONLY public.system_flag DROP CONSTRAINT system_flag_pkey;
ALTER TABLE ONLY public.schema_change_log DROP CONSTRAINT schema_change_log_pkey;
ALTER TABLE ONLY public.etl_soutab DROP CONSTRAINT pk_tid_colname_idx;
ALTER TABLE ONLY public.etl_job DROP CONSTRAINT pk_tb_job;
ALTER TABLE ONLY public.sys_item DROP CONSTRAINT pk_tb_dictionary;
ALTER TABLE ONLY public.sys_dict DROP CONSTRAINT pk_tb_dict;
...
ALTER TABLE ONLY public.etl_source DROP CONSTRAINT etl_source_pkey;
ALTER TABLE ONLY public.etl_jour DROP CONSTRAINT etl_jour_pkey;
ALTER TABLE ONLY public.etl_job_queue DROP CONSTRAINT etl_job_queue_pkey;
ALTER TABLE ONLY public.addax_log DROP CONSTRAINT addax_log_pkey;
ALTER TABLE public.schema_change_log ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.notification ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.etl_table ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.etl_source ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.etl_jour ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.etl_job_queue ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.addax_log ALTER COLUMN id DROP DEFAULT;
DROP VIEW public.vw_etl_table_with_source;
DROP TABLE public.users;
DROP SEQUENCE public.tb_imp_etl_tid_seq;
DROP SEQUENCE public.tb_addax_statistic_id_seq;
DROP TABLE public.system_flag;
DROP TABLE public.sys_item;
DROP TABLE public.sys_dict;
DROP SEQUENCE public.schema_change_log_id_seq;
DROP TABLE public.schema_change_log;
...
DROP SEQUENCE public.etl_source_id_seq;
DROP TABLE public.etl_source;
DROP SEQUENCE public.etl_jour_id_seq;
DROP TABLE public.etl_jour;
DROP SEQUENCE public.etl_job_queue_id_seq;
DROP TABLE public.etl_job_queue;
DROP TABLE public.etl_job;
DROP TABLE public.etl_column;
DROP TABLE public.authorities;
DROP SEQUENCE public.addax_log_id_seq;
DROP TABLE public.addax_log;
DROP FUNCTION public.etl_job_queue_set_updated_at();
DROP FUNCTION public.etl_job_queue_notify();
--
-- Name: etl_job_queue_notify(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.etl_job_queue_notify() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: etl_job_queue_set_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.etl_job_queue_set_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  NEW.updated_at := now();
...
--
-- Name: addax_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: etl_job_queue_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.etl_job_queue_id_seq OWNED BY public.etl_job_queue.id;
...
--
-- Name: etl_jour_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: etl_source_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: etl_soutab; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: COLUMN etl_statistic.run_date; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: tb_addax_statistic_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: tb_imp_etl_tid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.etl_job_queue ALTER COLUMN id SET DEFAULT nextval('public.etl_job_queue_id_seq'::regclass);
...
--
-- Name: etl_table id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: etl_soutab pk_tid_colname_idx; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_sta_tid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: etl_job_queue trg_etl_job_queue_notify_ins; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_etl_job_queue_notify_ins AFTER INSERT ON public.etl_job_queue FOR EACH ROW EXECUTE FUNCTION public.etl_job_queue_notify();


--
-- Name: etl_job_queue trg_etl_job_queue_notify_upd; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_etl_job_queue_notify_upd AFTER UPDATE OF status, available_at ON public.etl_job_queue FOR EACH ROW EXECUTE FUNCTION public.etl_job_queue_notify();


--
-- Name: etl_job_queue trg_etl_job_queue_set_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_etl_job_queue_set_updated_at BEFORE UPDATE ON public.etl_job_queue FOR EACH ROW EXECUTE FUNCTION public.etl_job_queue_set_updated_at();
